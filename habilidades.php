...
$result = $con->query($searchSkills);
#$User = mysqli_fetch_array($result);

if(isset($_POST['guardar'])){

  $query = "INSERT INTO habilidades(id_usuario, nombre) VALUES('$_SESSION[id]','$_POST[habilidad]')";

  if($con->query($query)){
    header('location: habilidades.php?exito=true;');
  }else{
    header('location: habilidades.php?error=true;');
  }
        ...
        <div class="userccount">
          <div class="formpanel">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="formrow">
                  <input type="text" name="habilidad" class="form-control" placeholder="Indique su habilidad">
                </div>
              </div>
            </div>
            <hr>
          ...
          <div class="formpanel"> 
             ...
             <div class="table-responsive">
                    <table class="table table-bordered" id="dataTableExample" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php while($skills = mysqli_fetch_array($result)){ ?>
                                 <tr>
                                     <td><?php echo $skills['nombre'] ?></td>
                                 </tr>
                                <?php } ?>
                            </tbody>
                    </table>
