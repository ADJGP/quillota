  ...
  if (is_string($_GET["pagina"])) {
    ...
    //Si la string es numérica, define la variable 'pagina'
     if (is_numeric($_GET["pagina"])) {
       ...
       if ($_GET["pagina"] == 1) {
         header("Location: listadooferta.php");
         die();
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-sm-6">
        <h1 class="page-heading">Listado de ofertas</h1>
      </div>
      <div class="col-md-6 col-sm-6">
...
$obtener_todo_BD = "SELECT * FROM ofertas";
...
SELECT * FROM `ofertas` ORDER BY `ofertas`.`id` 
            ...
            <div class="row">
              <div class="col-md-8 col-sm-8">
                ...
                <div class="jobinfo">
                  ...
                  <h3><a href="#."><?php echo $datos['nombres']; ?></a></h3>
