...
$result = $con->query($searchStyde);
#$User = mysqli_fetch_array($result);

if(isset($_POST['guardar'])){

  $query = "INSERT INTO estudios(id_usuario,titulo,año,descripcion) VALUES('$_SESSION[id]','$_POST[titulo]','$_POST[ano]','$_POST[descripcion]')";

  if($con->query($query)){
    header('location: mis_estudios.php?exito=true;');
  }else{
    header('location: mis_estudios.php?error=true;');
  }
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-sm-6">
        <h1 class="page-heading">Editar Mis Estudios</h1>
      </div>
      <div class="col-md-6 col-sm-6">
        ...
        <div class="userccount">
          <div class="formpanel">
            <form action="" method="POST">
             <!-- Education -->
             <h5>Registra el detalle de tus estudios:</h5>
            <div class="row">
              <div class="col-md-6">
                <div class="formrow">
              ...
              <div class="col-md-6">
                <div class="formrow">
                  <input type="text" max='4' name="ano" class="form-control" placeholder="Año de estudio" required>
                </div>
              </div>
              <div class="col-md-12">
                <div class="formrow">
                  <textarea class="form-control" name="descripcion" placeholder="Descripción del estudio" required></textarea>
                </div>
              </div>
            </div>
            <hr> 
          ...
          <div class="formpanel"> 
             ...
             <div class="table-responsive">
                    <table class="table table-bordered" id="dataTableExample" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php while($styde = mysqli_fetch_array($result)){ ?>
                                 <tr>
                                     <td><?php echo $styde['titulo'] ?></td>
                                     <td><?php echo $styde['año'] ?></td>
                                     <td><?php echo $styde['descripcion'] ?></td>
                                 </tr>
                                <?php } ?>
                            </tbody>
                    </table>
