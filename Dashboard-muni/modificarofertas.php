...
<?php
            ...
            $sql = mysqli_query($con, "SELECT * FROM ofertas WHERE id='$nik'");
            ...
            if(isset($_POST['add'])){
                ...
                $insert = mysqli_query($con, "UPDATE ofertas SET 
                    id_muni='$muni',titulo='$titulo',detalles= '$detalles',lugar='$lugar', id_rubro='$rubro',experiencia='$experiencia',edad='$edad', fecha='$fecha',sueldo='$sueldo' WHERE id='$nik' ") or die(mysqli_error());



                       if($insert){
            echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Los datos han sido guardados con éxito.
            <a href="tabla-ofertas.php">Regresar</a>
            </div>
