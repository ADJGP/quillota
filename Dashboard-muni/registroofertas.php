...
<?php
            if(isset($_POST['add'])){
               ...
               $rublo    = mysqli_real_escape_string($con,(strip_tags($_POST["rublo"],ENT_QUOTES)));//Escanpando caracteres 
                
            

                $cek = mysqli_query($con, "SELECT * FROM empresas WHERE rut='$rut'");
                if(mysqli_num_rows($cek) == 0){
                        $insert = mysqli_query($con, "INSERT INTO empresas (rut,titulo,muni,rublo)
                                                            VALUES ('$rut','$titulo','$muni','$rublo')") or die(mysqli_error());
                        if($insert){
            ...
            ?>
              ...
              <option > Municipalidad </option>
                ...
                <option value="5">La Cruz</option>
                  ...
                  <div class="form-group">
                    <label class="col-sm-3 control-label">Rublo</label>
                    <div class="col-sm-3">
                       <select name="rublo" class="form-control">
              <option > Rublo </option>
