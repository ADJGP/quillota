...
$result = $con->query("SELECT COUNT(*) as total_ofertas FROM ofertas WHERE titulo LIKE '%" . $palabras . "%'");
...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <h1 class="page-heading"><label for="">Listado de Ofertas de empleo</label></h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Buscador -->
        <form action="listado_ofertas_filtrado.php" method="POST">
        <div class="row">
        <div class="col-md-11">
    ...
    if ($num_total_rows > 0) {
        ...
        $result = $con->query("SELECT * FROM ofertas WHERE titulo LIKE '%" . $palabras . "%' ORDER BY id DESC LIMIT " . $start . ", " .NUM_ITEMS_BY_PAGE);
